class CreateSubjectsService < ApplicationService 
    ...
    def call  
        ...
        subject_names = ["Polski", "Matematyka", "Fizyka", "Chemia", "Geografia", "Historia", "WOS", "Informatyka", "Biologia", "Sztuka", "Dziennikarstwo", "Prawo", "Medycyna", "Nauki ścisłe", "Ekonomia", "Zarządzanie", "Angielski", "Hiszpański", "Niemiecki", "Historia Sztuki", "Włoski", "Rosyjski", "Francuski", "Gotowanie", "Muzyka", "Technik", "Antyk", "Fotografia", "Złotnik"]
